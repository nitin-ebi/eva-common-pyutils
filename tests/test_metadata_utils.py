...
class TestMetadata(TestCase):
    ...
    def test_get_new_variant_warehouse_db_name_from_assembly_and_taxonomy(self):
        expected_results = [
        ...
        for assembly, taxonomy, expected_db_name in expected_results:
            db_name = get_new_variant_warehouse_db_name_from_assembly_and_taxonomy(db_handle, assembly, taxonomy)
            assert db_name == expected_db_name

    def test_get_new_variant_warehouse_db_name_from_database(self):
        expected_results = [
        ...
        with ptaxonomy, passembly:
            for assembly, taxonomy, expected_db_name in expected_results:
                db_name = get_new_variant_warehouse_db_name_from_assembly_and_taxonomy(None, assembly, taxonomy)
                assert db_name == expected_db_name
